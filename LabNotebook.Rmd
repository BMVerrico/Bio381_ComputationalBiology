...
* [Page 11: 2018-02-07](#id-section10).
* [Page 12: 2018-02-08](#id-section10).
* [Page 13: 2018-02-13](#id-section10).
...
# print the rows with the missing data
is.na(mat) # all well and good for small matrices

subset(mat, is.na(mat[,2]))
subset(mat, is.na(mat[,1]))
subset(mat, is.na(mat[,1]) && is.na(mat[,2])) # doesnt work


# this still isn't working
tmp=matrix(nrow=10, ncol=2)
tmp[,1]=c(1,2,3,NA,NA,4,6,4,3,4)
tmp[,2]=c(4,NA,5,7,8,NA,NA,NA,9,8)
colnames(tmp)=c("hello", "bye")
tmp[(which(is.na(tmp))/ncol(tmp)),]
# tmp[(which(is.na(tmp))/ncol(tmp)),]
