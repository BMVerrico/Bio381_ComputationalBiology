...
geom_text(aes(3,2.25, label = "Low Garden"), size=2) +
geom_text(aes(3,4.25, label = "Mid Garden"), size=2) +
  geom_text(aes(3,6, label = "High Garden"), size=2) +
...
```{r}
Low + Mid + High + plot_layout(ncol=1) | tdplot
```